...
/*! \brief the principial function unitary testing input
 * constructing a abstract hashTable_CELLS and Tests if
 * the allocation memory happened as we want
 * that's it;nothing to assert special thing FOR.
 */
