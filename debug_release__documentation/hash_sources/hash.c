...
/*! \brief describing the main cell double chained list data
 * contains void* pointer 'value'
 * and classic prev and next adress points to the double extremities
 * of the encapsulation DATA.
 */
